...
const ContactPage = ({ data }) => (
  <Layout>
    ...
    <div css={[tw`flex flex-col items-center`]}>
      ...
      <div css={[tw`mt-4`]}>
        <p>edknprocessorは、えどがわけんぴ(またはえんがわ)のポートフォリオサイトです。漫画アシスタント(背景作画、トーン仕上げ等)、イラストのお仕事を募集中です。(レギュラーアシスタント4件と掛け持ちになります。)</p>
    ...
    <div css={[tw`mt-8`]}>
      ...
      <dl>
        ...
        <dd>
          ...
          少女向けコミックの臨時アシスタント(背景・トーン)<br/>
          Webコミックのアシスタント2件(背景・トーン)
        </dd>
        <dt>2021年~</dt>
        <dd>
          Webコミック(異世界もの)のレギュラーアシスタント(背景描き起こし・3D変換線画なじませ・トーン)
        </dd>
        <dt>2021年~2022年</dt>
        <dd>
          TLコミックのレギュラーアシスタント(背景描き起こし・3D配置・人物トーン)
        </dd>
        <dt>2019年~2021年</dt>
